...
if __name__ == '__main__':
    ...
    print('The shape of training: ', gesture_data.train_x.shape)
    print('The shape of test: ', gesture_data.test_x.shape)
    print('The shape of valid: ', gesture_data.valid_x.shape)