...
from model.structure_evolution import weight_sampler_strict_number, prune_threshold, grow_cost
...
def train(model_dir,
    ...
    for epoch in range(maxepoches):
        ...
        with tf.Session() as sess:
            ...
            w_rec *= w_rec_core
            w_rec_mask = grow_cost(noRewires=noMov, rewiredWeights=w_rec,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modeldir', type=str, default='experiments/DMTask/rewiring_DSR/DSR_with_cost_l1')
