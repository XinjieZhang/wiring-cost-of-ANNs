...
from model.structure_evolution import weight_sampler_strict_number, rewireMask, rewireMask_improved
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modeldir', type=str, default='experiments/DMTask/rewiring_SET/SET_with_cost_l2')
    ...
    hp = {'activation': 'softplus',
          ...
          'epsilon_rec': 1,
          'num_edges': 10000,
          'l1_weight': 0,  # L1 + wiring cost
          'l2_weight': 3e-4,  # L2 + wiring cost
          'zeta': 0.2
          }
    train(args.modeldir,
          ruleset='dm',
